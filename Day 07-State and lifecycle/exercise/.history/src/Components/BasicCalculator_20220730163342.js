            ...
            <div className="container">
                <div className="row">
                    <div className="col-xxl-4">
                        <form>
                            <div className="mb-3">
                                <input type="text" className="form-control" id="inputTop" value={this.state.fValue} onChange={this.updateInputValueT} ></input>
                            </div>
                            <div className="mb-3">
                                <input type="text" className="form-control" id="inputBot" value={this.state.sValue} onChange={this.updateInputValueB} ></input>
                            </div>
                        </form>
