...
class ToDo extends Component {
    constructor(props) {
        ...
        getInputValue = (evt)=>{
            let objectL = this.state.todo.leangth;
            this.setState({ todo[objectL-1].title: parseFloat(evt.target.value) });
        }
    render() {
        return (
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-xxl-4">
                        ...
                        <input type="text" className="form-control mb-3" id="input-todo" onChange={this.getInputValue} ></input>
