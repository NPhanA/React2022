            ...
            <div className="container">
                <div className="row">
                    <div className="col-xxl-4">
                        <form>
                            <div className="mb-3">
                                <input type="text" className="form-control" id="inputTop"  onChange= ></input>
                            </div>
                            <div className="mb-3">
                                <input type="text" className="form-control" id="inputBot"  onChange={this.updateInputValueB} ></input>
                            </div>
                        </form>
                        <FormType type="number" className="form-control" id="inputTop" dId="inputBot" change={this.updateInputValueT}></FormType>
