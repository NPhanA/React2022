...
export default function ToDo  {
    ...
    const addTodo = () => {
        ...
        let currDate = document.getElementById("input-todo")
        let currValue = document.getElementById("input-todo")
        setTodo(...todo, { title: currValue, })
    }
    return (
                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            ...
                            <input type="text" className="form-control mb-3" placeholder="Content" id="content"></input>
                        </div>
