            ...
            <div className="container">
                <div className="row">
                    <div className="col-xxl-4">
                        <form>
                            <div className="mb-3">
                                <input type="text" className="form-control" id="inputTop" onKeyUp={this.getInputTop} onChange={this.getInputTop(this)}></input>
                            </div>
                            <div className="mb-3">
                                <input type="text" className="form-control" id="inputBot" onKeyUp={this.getInputBot} onChange={this.getInputBot}></input>
                            </div>
                        </form>
