...
import TodoCard from "./CardComponents";
                    ...
                    <div>
                        {
                            todo.map((currentValue, index) => (
                                <TodoCard key={index} title={currentValue.title} content={currentValue.content} year={currentValue.date}></TodoCard>
                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        ...
                        <div className="modal-footer">
                            ...
                            <button type="button" className="btn btn-primary" data-bs-dismiss="modal" onClick={addTodo}>Save changes</button>
                        </div>
                    </div>
                </div>
            </div>
