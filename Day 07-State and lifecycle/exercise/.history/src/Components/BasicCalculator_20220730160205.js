...
class Calculator extends Component {
    ...
    plusCalculate = ()=>{
        ...
        this.state.result = this.state.fValue + this.state.sValue;
    }
    render() {
        return (
            <div className="container">
                <div className="row">
                    <div className="col-xxl-4">
                        <form>
                            <div className="mb-3">
                                <input type="number" className="form-control" id="inputTop" onKeyUp={this.getInputTop(this)}></input>
                            </div>
                            <div className="mb-3">
                                <input type="number" className="form-control" id="inputBot" onKeyUp={this.getInputBot(this)}></input>
                            </div>
                        </form>
