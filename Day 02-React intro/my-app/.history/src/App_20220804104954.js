...
import StartEndComponents from "../src/Component/StartEndComponents";
import ButtonGroup from '../src/Component/ButtonGroupComponents';
import SelectCard from '../src/Component/SelectClass';
            ...
            <div className="col-xxl-11">
              <form onSubmit={handleEditFormSubmit}>
                <table class="table table-striped table-dark mt-3 text-center" >
                  ...
                  <tbody>
                    {
                      contacts.map((currentValue, index) => (
                        <Fragment >
                          {editContactId  === currentValue.id ? <TableRowInput editFormData={editFormData}
                            handleEditFormChange={handleEditFormChange} numbers={index}
                            handleCancelClick={handleCancelClick}></TableRowInput> : <TableRow contact={contacts} number={index}
                              handleEditClick={handleEditClick}
                              handleDeleteClick={handleDeleteClick}></TableRow>}
                        </Fragment>
