...
export default function TeacherManager() {
    let [teacher, setTeachers] = useState([
        { id: 0, name: "", age: 0, address: "", phoneNumber: 0, teachedClass: "" },
    ])
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        teacher.map((currentValue, index) => (
                                                <TableRow key={index} numbers={index} age = {currentValue.age} address = {currentValue.address} phoneNumber = {currentValue.phoneNumber} teachedClass ={currentValue.teachedClass}></TableRow>
                                        ))
                                        }
