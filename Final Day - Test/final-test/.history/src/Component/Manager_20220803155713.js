                            ...
                            <table class="table table-striped table-dark mt-3">
                                ...
                                <tbody>
                                        ...
                                        teacher.map((currentValue, index) => (
                                                <TableRow key={index} name={currentValue.name} numbers={index} age = {currentValue.age} address = {currentValue.address} phoneNumber = {currentValue.phoneNumber} teachedClass ={currentValue.teachedClass}></TableRow>
                                        ))
                                        }
                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <form><input type="text" className="form-control mb-3" placeholder="Name" id="input-name" required></input>
                        ...
                        <div className="modal-footer">
                            ...
                            <button type="submit" className="btn btn-primary" data-bs-dismiss="modal" onClick={addTeacher} >Save changes</button>
                        </div>
                    </div>
                </div>
            </div>
