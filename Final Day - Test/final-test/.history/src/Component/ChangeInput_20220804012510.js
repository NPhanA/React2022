export default function TableRowInput(props) {
    return (
        <tr>
            ...
            <td>
            <input type="text" className="form-control" placeholder="Age" name="Age" required="required" onChange={props.onChange} defaultValue={props.age}></input>
            </td>
            <td>
            ...
            <td>
            <button type="submit" className="btn btn-primary" onSubmit={props.onSubmit}>Save</button>
            </td>
        </tr>
    )
}