...
export default function TeacherManager() {
    ...
    const addTeacher = () => {
        ...
        if (currValue == null || currDate == null || currAddress == null || currNumbers == null || currClass == null) {
                    ...
                    <div className="modal-content">
                        ...
                        <form>
                            ...
                            <div className="modal-footer">
                                ...
                                <button type="submit" className="btn btn-primary" onClick={addTeacher} >Save changes</button>
                            </div>
                        </form>
                    </div>
                </div>
