                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        teacher.map((currentValue, index) => (
                                                <TableRow key={index}  age = {currentValue.age} address = {currentValue.address} phoneNumber = {currentValue.phoneNumber} teachedClass ={currentValue.teachedClass}></TableRow>
                                        ))
                                        }
