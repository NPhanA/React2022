...
export default function TeacherManager() {
    ...
    function deleted(id){
        var index = teacher.map(function(e) { return e.id; }).indexOf(id);
                                ...
                                <tbody>
                                    {
                                        teacher.map((currentValue, index) => (
                                            <TableRow key={index} name={currentValue.name} numbers={index} age={currentValue.age} address={currentValue.address} phoneNumber={currentValue.phoneNumber} teachedClass={currentValue.teachedClass} onClick={deleted(this)}  ></TableRow>
                                        ))
                                    }
                                </tbody>
                            </table>
