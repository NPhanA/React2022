                                    ...
                                    <tbody>
                                        {
                                            teacher.map((currentValue, index) => (
                                                <Fragment >
                                                    {editContactID === currentValue.id ? <TableRowInput onChange={editFormChange} onSubmit={handleEditFormSubmit}  numbers={index} age={currentValue.age} address={currentValue.address} name={currentValue.name} phoneNumber={currentValue.phoneNumber} teachedClass={currentValue.teachedClass} ></TableRowInput> : <TableRow change={(event) => handleEditClick(event, currentValue.id)} key={index} name={currentValue.name} numbers={index} age={currentValue.age} address={currentValue.address} phoneNumber={currentValue.phoneNumber} teachedClass={currentValue.teachedClass} enter={() => handleDeleteClick(currentValue.id)}></TableRow>}
                                                </Fragment>
