...
export default function TeacherManager() {
    ...
    const filterEvenResults = (id) => setTeachers(teacher => teacher.filter(teacher=>teacher.id!=id))
                                ...
                                <tbody>
                                    {
                                        teacher.map((currentValue, index) => (
                                            <TableRow key={index} name={currentValue.name} numbers={index} age={currentValue.age} address={currentValue.address} phoneNumber={currentValue.phoneNumber} teachedClass={currentValue.teachedClass} onClick={filterEvenResults(this)} ></TableRow>
                                        ))
                                    }
                                </tbody>
                            </table>
