                                    ...
                                    <tbody>
                                        {
                                            teacher.map((currentValue, index) => (
                                                <Fragment>
                                                    {editContactID === currentValue.id ? <TableRowInput onChange={editFormChange} onChangeAge={editFormChangeName} onSubmit={handleEditFormSubmit} numbers={index} age={editFormData.age} address={editFormData.address} name={editFormData.name} phoneNumber={editFormData.phoneNumber} teachedClass={editFormData.teachedClass}></TableRowInput> : <TableRow change={(event) => handleEditClick(event, currentValue)} key={index} name={currentValue.name} numbers={index} age={currentValue.age} address={currentValue.address} phoneNumber={currentValue.phoneNumber} teachedClass={currentValue.teachedClass} enter={()=> handleDeleteClick(currentValue.id)}></TableRow>}
                                                </Fragment>
