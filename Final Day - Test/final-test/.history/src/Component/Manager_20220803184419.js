                                    ...
                                    <tbody>
                                        {
                                            teacher.map((currentValue, index) => (
                                                <Fragment>
                                                    {editContactID === currentValue.id ? <TableRowInput numbers={index}></TableRowInput> : <TableRow change={(event)=> handleEditClick(event,contact)} key={index} name={currentValue.name} numbers={index} age={currentValue.age} address={currentValue.address} phoneNumber={currentValue.phoneNumber} teachedClass={currentValue.teachedClass} enter={handleDeleteClick}></TableRow>}
                                                </Fragment>
