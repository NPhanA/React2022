                                    ...
                                    <tbody>
                                        {
                                            teacher.map((currentValue, index) => (
                                                <Fragment>
                                                    {editContactID === currentValue.id ? <TableRowInput onChangeAge={editFormChangeAge} onChange={editFormChange} numbers={index} Age={editFormData.age} Address={editFormData.address} name={editFormData.name} PhoneNumber={editFormData.phoneNumber} TeachedClass={editFormData.teachedClass}></TableRowInput> : <TableRow change={(event) => handleEditClick(event, currentValue)} key={index} name={currentValue.name} numbers={index} age={currentValue.age} address={currentValue.address} phoneNumber={currentValue.phoneNumber} teachedClass={currentValue.teachedClass} enter={handleDeleteClick}></TableRow>}
                                                </Fragment>
