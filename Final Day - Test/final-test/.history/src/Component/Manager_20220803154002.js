                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        teacher.map((currentValue, index) => (
                                                <TableRow key={index} numbers={index} age = {currentValue.age} address = {currentValue.address} phoneNumber = {currentValue.phoneNumber} teachedClass ={currentValue.teachedClass}
                                        ))
                                        }
                                    </tr>
                                </tbody>
