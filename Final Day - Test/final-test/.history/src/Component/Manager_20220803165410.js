                                ...
                                <tbody>
                                    {
                                        teacher.map((currentValue, index) => (
                                            <TableRow key={index} name={currentValue.name} numbers={index} age={currentValue.age} address={currentValue.address} phoneNumber={currentValue.phoneNumber} teachedClass={currentValue.teachedClass} onClick={()=>deleteItem(teacher.id)}  ></TableRow>
                                        ))
                                    }
                                </tbody>
                            </table>
