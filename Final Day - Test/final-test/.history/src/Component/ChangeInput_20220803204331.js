export default function TableRowInput(props) {
    return (
        <tr>
            ...
            <td>
            <input type="text" className="form-control" placeholder="Address" name="Address" required="required" value={props.address}></input>
            </td>
            <td>
            <input type="text" className="form-control" placeholder="Phone Number" name="PhoneNumber" required="required"  value={props.phoneNumber}></input>
            </td>
            <td>
            <input type="text" className="form-control" placeholder="Class" name="TeachedClass" required="required"  value={props.teachedClass}></input>
            </td>
            <td>
