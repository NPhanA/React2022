                                ...
                                <tbody>
                                    {
                                        teacher.map((currentValue, index) => (
                                            <Fragment>
                                                <TableRowInput numbers={index}></TableRowInput>
                                            <TableRow key={index} name={currentValue.name} numbers={index} age={currentValue.age} address={currentValue.address} phoneNumber={currentValue.phoneNumber} teachedClass={currentValue.teachedClass} enter={handleDeleteClick}></TableRow>
                                            </Fragment>
