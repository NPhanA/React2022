...
export default function TeacherManager() {
    ...
    setTeachers(teacher => teacher.filter(entry => entry.name !== selected))
                                ...
                                <tbody>
                                    {
                                        teacher.map((currentValue, index) => (
                                            <TableRow key={index} name={currentValue.name} numbers={index} age={currentValue.age} address={currentValue.address} phoneNumber={currentValue.phoneNumber} teachedClass={currentValue.teachedClass} enter={handleRemoveItem}></TableRow>
                                        ))
                                    }
                                </tbody>
                            </table>
