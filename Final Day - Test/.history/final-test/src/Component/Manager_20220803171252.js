...
export default function TeacherManager() {
    ...
    const handleRemoveItem = (id) => {
        setTeachers(teacher.filter(teacher => teacher.id !== id));
       };
                                ...
                                <tbody>
                                    {
                                        teacher.map((currentValue, index) => (
                                            <TableRow key={index} name={currentValue.name} numbers={index} age={currentValue.age} address={currentValue.address} phoneNumber={currentValue.phoneNumber} teachedClass={currentValue.teachedClass} enter={handleRemoveItem(this)}></TableRow>
                                        ))
                                    }
                                </tbody>
                            </table>
