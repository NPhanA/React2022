...
export default function TeacherManager() {
    ...
    const handleRemoveItem = (e) => {
        ...
        setTeachers(teacher.filter(item => item.id !== id));
       };
                                ...
                                <tbody>
                                    {
                                        teacher.map((currentValue, index) => (
                                            <TableRow key={index} name={currentValue.name} numbers={index} age={currentValue.age} address={currentValue.address} phoneNumber={currentValue.phoneNumber} teachedClass={currentValue.teachedClass} onClick={handleRemoveItem}></TableRow>
                                        ))
                                    }
                                </tbody>
                            </table>
