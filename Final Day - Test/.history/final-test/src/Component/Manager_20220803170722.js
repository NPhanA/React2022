...
export default function TeacherManager() {
    ...
    function deleteElement(element){
        document.querySelector(element).parent().remove();
    }
                                ...
                                <tbody>
                                    {
                                        teacher.map((currentValue, index) => (
                                            <TableRow key={index} name={currentValue.name} numbers={index} age={currentValue.age} address={currentValue.address} phoneNumber={currentValue.phoneNumber} teachedClass={currentValue.teachedClass} onClick={deleteElement(this)}></TableRow>
                                        ))
                                    }
                                </tbody>
                            </table>
