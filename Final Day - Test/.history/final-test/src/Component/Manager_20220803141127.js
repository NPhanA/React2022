    ...
    return (
        <div>
            <nav class="navbar navbar-expand-lg navbar-light bg-info">
                ...
                <div className="col-xxl-9 f fst-italic text-center fs-5">"Every things has a start and an end"</div>
                <div className="col-xxl-1">
                    <img src="https://www.w3schools.com/w3images/avatar2.png" alt="Avatar" class="avatar me-2"></img>
                   <span>admin</span></div>

                   <NavBarComponents contentTitle="VTI Teacher Manager" contentText="Every things has a start and an end" role="admin" ></NavBarComponents>
            </nav>
            <div className="row">
                    ...
                    <div className="container">
                        ...
                        <div className="fs-5 mt-5 d-flex ">
                            ...
                            <div className="col-xxl-7 d-flex justify-content-end">
                                <div class="btn-group mr-2 me-2" role="group" aria-label="First group">
                                ...
                                <div class="btn-group mr-2" role="group" aria-label="First group">
                                    <button type="button" class="btn btn-dark me-2">Import</button>
                                </div>
                                <div class="btn-group mr-2" role="group" aria-label="First group">
                                    <button type="button" class="btn btn-info">Export</button>
                                    <button type="button" class="btn btn-info ms-1">↓</button>
                                </div>
                            </div>
                        </div>
                    </div>
