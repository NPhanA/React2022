                ...
                <div className="col-xs-12 col-xxl-4">
                    <form className="form-inline">
                        ...
                        <div className="col-xs-12 col-xxl-12">
                            <input type="email" className="form-control form-control-md mt-3 mb-4" placeholder="Email address" required></input>
                            <input type="password" className="form-control form-control-md" placeholder="Password" required></input>
                        </div>
                        </form>
